...
public class CorpManageServiceImpl implements CorpManageService {
    ...
    @Override
    public ServiceResult<CorpVO> getCorp(String corpId){
        try {
    ...
    @Override
    public ServiceResult<String> registerEvent(String suiteKey, String call_back_tag, String accessToken,String token,String aes_key,String rtn_url){
    	ServiceResult<String> sr = confOapiRequestHelper.getCallBack(suiteKey,call_back_tag,accessToken,token,aes_key,rtn_url);
    	return sr;
    }
    
    @Override
    public ServiceResult<String> updateEvent(String suiteKey, String call_back_tag, String accessToken,String token,String aes_key,String rtn_url){
    	ServiceResult<String> sr = confOapiRequestHelper.updateCallBack(suiteKey,call_back_tag,accessToken,token,aes_key,rtn_url);
    	return sr;
    }
